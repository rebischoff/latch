...
- Skim the [phase README](../README.md), [`../decisions.md`](../decisions.md), and [`../../../reference/approval-trails.md`](../../../reference/approval-trails.md).
...
| [`../../../reference/approval-trails.md`](../../../reference/approval-trails.md) | Storage decision; Surface terminology; state machine; visibility rules |
...
Per [`../../../reference/bulk-operations.md`](../../../reference/bulk-operations.md): gated bulk patch → **N** pending rows, same `batch_id`. Reviewer accepts/rejects **per row** in v1. Live Fields in the same bulk patch still apply per existing bulk algorithm when not gated.
...
- [x] [`../../../reference/approval-trails.md`](../../../reference/approval-trails.md) updated (storage + Surface terms)
