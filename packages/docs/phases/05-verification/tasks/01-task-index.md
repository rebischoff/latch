...
| Artifact | Location |
|----------|----------|
| `MemoryPendingStore`, `PendingStore` interface | [`packages/approval/src/pending-store.ts`](../../../../packages/approval/src/pending-store.ts) |
| `acceptPending`, patch → pending split | [`packages/dal/src/create-surface-dal.ts`](../../../../packages/dal/src/create-surface-dal.ts) |
...
| `AuditAction` `approve` / `reject` | [`packages/audit/src/types.ts`](../../../../packages/audit/src/types.ts) |
...
| Phase 04 audit immutability | [`../../04-audit-lifecycle/`](../../04-audit-lifecycle/) |
