...
| R6.4 | Bulk operations produce per-row audit + optional batch summary | Planned (see [`architecture/bulk-operations.md`](../reference/bulk-operations.md)) |
...
See [`architecture/approval-trails.md`](../reference/approval-trails.md).
...
See [`architecture/bulk-operations.md`](../reference/bulk-operations.md).
