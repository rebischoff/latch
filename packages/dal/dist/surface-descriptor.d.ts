...
import type { FieldId, Manifest, PermissionContext, SurfaceId } from "@latch/contracts";
...
export type SurfaceDescriptor<TRow, TRelated = unknown> = {
    ...
    projectRow: (row: TRow, manifest: Manifest, related: TRelated, listJoins?: Record<string, unknown>) => Record<string, unknown>;
    applyPatch: (row: TRow, patch: Record<string, unknown>) => TRow;
    applyRelatedPatch?: (entityId: string, patch: Record<string, unknown>) => TRelated | undefined;
     ...
     */
    deleteAuditSnapshot?: (row: TRow, related: TRelated) => Record<string, unknown>;
...
//# sourceMappingURL=surface-descriptor.d.ts.map