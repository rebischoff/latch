import type { FieldAction, FieldId, RoleId, RoleSurfacePolicy, SurfaceId } from "@latch/contracts";
...
export declare const definePolicyRegistry: (...surfaces: SurfacePolicyDefinition[]) => PolicyRegistry;
/** Assemble one catalog entry (identity helper for generated files). */
export declare const defineSurfacePolicy: (catalog: SurfacePolicyDefinition) => SurfacePolicyDefinition;
