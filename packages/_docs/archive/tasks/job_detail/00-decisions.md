...
| [`../../architecture/access-control.md`](../../../../policy/docs/access-control.md) | Add Decision: Step 3 pilot Surface |
| [`../../architecture/access-control.md`](../../../../policy/docs/access-control.md) | Confirm Decision: `union_grants` v1 |
...
2. **D4** — Confirm v1 implements **`union_grants` only** with global **`denyWins: true`** ([`../../architecture/access-control.md`](../../../../policy/docs/access-control.md)).
