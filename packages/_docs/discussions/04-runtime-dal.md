...
- [`../reference/permissions-and-ui-sync.md`](../reference/permissions-and-ui-sync.md), [`../reference/api-style.md`](../reference/api-style.md), [`packages/dal/src/create-surface-dal.ts`](../../dal/src/create-surface-dal.ts)
