...
- True transactional accept is **deferred** to when the business store is Postgres-backed; note this in the task and in [`../../../reference/approval-trails.md`](../../../../approval/docs/approval-trails.md). When `createPostgresPendingStore` + a Postgres business store both exist, wrap steps 2–4 in one `BEGIN/COMMIT`.
...
| [`../../../reference/audit-and-lifecycle.md`](../../../../audit/docs/audit-and-lifecycle.md) | Withdraw audit behavior |
