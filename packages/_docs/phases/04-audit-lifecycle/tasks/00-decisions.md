...
- Skim the [phase README](../README.md), [`../decisions.md`](../decisions.md), and [`../../../reference/audit-and-lifecycle.md`](../../../../audit/docs/audit-and-lifecycle.md).
...
| [`../../../reference/audit-and-lifecycle.md`](../../../../audit/docs/audit-and-lifecycle.md) | Add Decision blocks for cascade table + restore replay; align event shape with locked choices |
...
**API:** Use **`deleteAuditSnapshot(row, related)`** on the descriptor for delete paths; keep **`auditSnapshot(row)`** row-only for patch/approve audits. DAL calls `store.getRelated(id)` before delete ([`delete-row.ts`](../../../../dal/src/delete-row.ts) must pass `related`).
...
**Bulk delete:** Same snapshot shape per row on recoverable Surfaces; optional `bulk_summary` row unchanged ([`../../../reference/bulk-operations.md`](../../../../dal/docs/bulk-operations.md)).
...
**Rationale:** DAL `writeAudit` is the v1 path; table triggers duplicate rows unless session-gated ([`audit-and-lifecycle.md`](../../../../audit/docs/audit-and-lifecycle.md) Decision 2026-05-28). Direct-SQL bypass remains a documented ops risk; optional hardening is post-v1 or a change order.
...
- [x] [`../../../reference/audit-and-lifecycle.md`](../../../../audit/docs/audit-and-lifecycle.md) updated with cascade + restore decisions
