...
| `PermissionContext` | [`packages/contracts`](../../../../contracts/src/index.ts) |
| `latch_user_roles` IAM | [`../../03-identity-iam/`](../../../../../docs/phases/03-identity-iam) |
| `latch_audit` immutability (T6) | [`../../04-audit-lifecycle/`](../../../../../docs/phases/04-audit-lifecycle) |
| Pending store | [`../../05-verification/`](../../../../../docs/phases/05-verification) |
