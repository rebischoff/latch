...
| Date | Topic | Choice |
|------|-------|--------|
| 2026-05-27 | Bulk model | Per-row eval; `partial` default + `all_or_nothing` flag. See [`../../reference/bulk-operations.md`](../../../dal/docs/bulk-operations.md) |
...
| 2026-05-29 | Bulk skip reasons | Invisible rows → `not_found`; field/action denial → `forbidden_field` / `forbidden_row`. See [`../../reference/bulk-operations.md`](../../../dal/docs/bulk-operations.md) |
