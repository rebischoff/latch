...
>
> **Execution:** Work one file at a time under [`tasks/`](../../../../docs/phases/01-data-access/tasks). After each task passes its **Verify** gate, update this phase's [`STATUS.md`](./STATUS.md) (and the root [`STATUS.md`](../../../../STATUS.md) if the active phase changes).
...
| DAL `bulkUpdate` + bulk delete per [`../../reference/bulk-operations.md`](../../../dal/docs/bulk-operations.md) | Restore-from-audit UI (Phase 04) |
...
6. **Audit** — one row per successful change; optional `bulk_summary` with `request_id` (see [`../../reference/audit-and-lifecycle.md`](../../../audit/docs/audit-and-lifecycle.md)).
...
Per [`../../reference/api-style.md`](../../reference/api-style.md) and [`../../reference/bulk-operations.md`](../../../dal/docs/bulk-operations.md):
...
Executable task files live under [`tasks/`](../../../../docs/phases/01-data-access/tasks). Start at [06-surface-yaml.md](./tasks/06-surface-yaml.md) (00–01 are docs-only setup, complete).
...
Tasks **14–15, 17–19** are unchanged from the pilot (Server Action, stub principal, audit triggers, approval, react gates) — only extend if the list page needs new gates. See the archived pilot tasks: [`../../archive/tasks/job_detail/`](../../../../docs/archive/tasks/job_detail).
...
- [`../../foundations/scope.md`](../../foundations/scope.md) · [`../../foundations/use-cases.md`](../../foundations/use-cases.md) (S1, S2) · [`../../reference/bulk-operations.md`](../../../dal/docs/bulk-operations.md)
- Pilot history: [`../../archive/step-3-pilot-surface.md`](../../archive/step-3-pilot-surface.md) · [`../../archive/tasks/job_detail/`](../../../../docs/archive/tasks/job_detail)
