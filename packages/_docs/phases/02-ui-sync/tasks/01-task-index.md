...
| Artifact | Location |
|----------|----------|
| `CapabilitiesProvider`, `<Can>`, `<FieldControl>` | [`packages/react/src`](../../../../react/src) — done in pilot ([archive 19](../../../archive/tasks/job_detail/19-react-gates.md)) |
...
3. Update root [`../../../STATUS.md`](../../../../../docs/STATUS.md) only when the Phase 02 definition of done is complete (repoint active phase).
