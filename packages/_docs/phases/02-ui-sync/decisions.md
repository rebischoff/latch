...
**Rationale:** [`access-control.md`](../../../policy/docs/access-control.md) requires cross-Surface access to be explicit by id; today `job_list` only exposes display strings (`customer_site`), not a stable key.
