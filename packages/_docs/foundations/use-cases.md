...
4. Server re-resolves manifest. DAL evaluates `write` on `assignment` Field **per row**. Rows the admin can't touch are reported back as failures (no partial corruption). See [`bulk-operations.md`](../../dal/docs/bulk-operations.md).
...
- [`scope.md`](./scope.md)
- [`architecture/bulk-operations.md`](../../dal/docs/bulk-operations.md)
- [`architecture/access-control.md`](../../policy/docs/access-control.md)
