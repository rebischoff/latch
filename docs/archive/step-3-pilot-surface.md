...
> **Execution:** Work one file at a time under [`tasks/job_detail/`](./tasks/job_detail/). After each task passes its **Verify** gate, update [`STATUS.md`](../../STATUS.md) to the next task.
