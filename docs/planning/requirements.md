...
| R1.2 | PostgreSQL is the primary datastore | Planned (Docker local; Neon preview/prod) |
...
| R6.4 | Bulk operations produce per-row audit + optional batch summary | Planned (see [`architecture/bulk-operations.md`](./architecture/bulk-operations.md)) |

### R7 — Soft and hard deletes

| ID | Requirement | Status |
|----|-------------|--------|
| R7.1 | Soft delete: `deleted_at` / `deleted_by`, hidden from default queries | Planned (v1) |
| R7.2 | Hard delete | **Deferred** post-v1 |
| R7.3 | Policy controls who may soft-delete vs hard-delete vs restore | Planned (soft-delete only in v1) |
...
See [`architecture/approval-trails.md`](./architecture/approval-trails.md).
...
See [`architecture/permissions-and-ui-sync.md`](./architecture/permissions-and-ui-sync.md).

### R11 — Bulk operations *(new)*

| ID | Requirement | Status |
|----|-------------|--------|
| R11.1 | Bulk update and bulk soft-delete supported via DAL + REST endpoint | Planned (v1) |
...
See [`architecture/bulk-operations.md`](./architecture/bulk-operations.md).
...
See [`architecture/api-style.md`](./architecture/api-style.md).
...
See [`architecture/packages.md`](./architecture/packages.md).

## Non-functional (draft)

| ID | Requirement |
|----|-------------|
| NF1 | Local dev: single `docker compose up` + `npm run dev` |
