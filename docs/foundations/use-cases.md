# Use cases — service-trades vertical
...
### S2 — Office Admin reassigns 20 jobs (bulk)
...
### S4 — Field Tech tries to access another tech's job
...
### S5 — Accountant exports financials

1. Accountant opens `/reports/financials`.
2. Route handler — not a Server Action, because we want CSV streaming + future external access.
...
- Customer portal / external sign-off (requires external reviewers — deferred).
