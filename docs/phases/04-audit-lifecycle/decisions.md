...
**Canonical detail:** [`../../reference/audit-and-lifecycle.md`](../../reference/audit-and-lifecycle.md) · [`../../../../apps/crm/docs/DATABASE.md`](../../../../apps/crm/docs/DATABASE.md#cascade-on-delete-v1-pilot).
...
**Pilot:** `office_admin` has `restore` on `job_detail` — task **06** implements full snapshot for jobs. Bulk delete on recoverable Surfaces uses the same per-row shape; optional `bulk_summary` unchanged ([`../../reference/bulk-operations.md`](../../reference/bulk-operations.md)).
