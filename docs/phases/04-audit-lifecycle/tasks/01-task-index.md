...
| Artifact | Location |
|----------|----------|
| `writeAudit`, `AuditAction` types | [`packages/audit`](../../../../packages/audit) |
| `deleteRowWithAudit`, bulk delete audit | [`packages/dal/src/delete-row.ts`](../../../../packages/dal/src/delete-row.ts), [`bulk.ts`](../../../../packages/dal/src/bulk.ts) |
