...
| Artifact | Location |
|----------|----------|
| Single-record DAL | [`packages/dal/src/jobs/repository.ts`](../../../../packages/dal/src/jobs/repository.ts) |
...
| Pilot task archive | [`../../../archive/tasks/job_detail/`](../../../archive/tasks/job_detail/) |
...
3. Update root [`../../../STATUS.md`](../../../STATUS.md) only when Phase 01 definition of done is complete (repoint active phase).
