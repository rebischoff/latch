...
- Task **08** — [`job_list.schema.generated.ts`](../../../apps/web/modules/job/generated/job_list.schema.generated.ts); `COLUMN_ZOD` extended for list joins; `npm run codegen:check` passes.
- Task **07** — [`job_list.policies.yaml`](../../../apps/web/modules/job/job_list.policies.yaml) + [`job-list.ts`](../../../packages/policy/src/surfaces/job-list.ts) wired in `PolicyService`.
- Task **06** — [`job_list.surface.yaml`](../../../apps/web/modules/job/job_list.surface.yaml) (Fields: `summary`, `customer_site`, `financial_terms`, `assignments`).
