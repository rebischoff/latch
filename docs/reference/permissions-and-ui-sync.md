...
How Latch keeps **backend authorization**, **data access**, **validation**, and **frontend rendering** aligned. Complements [access-control.md](./access-control.md).
...
Break-glass / elevated access should use these roles with **enhanced audit** (details TBD in [access-control.md](./access-control.md)).
...
See [metadata-and-codegen.md](./metadata-and-codegen.md).
...
- [`access-control.md`](./access-control.md) — resource hierarchy, roles
