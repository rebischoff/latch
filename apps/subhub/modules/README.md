...
**Timestamps / audit metadata:** omit `created_at`, `updated_at`, and `created_by` from Fields unless manifest-gated UI needs them — see [decisions.md](../docs/decisions.md#decision-row-timestamps-vs-audit--ddl-vs-surface-fields-2026-06-13).
