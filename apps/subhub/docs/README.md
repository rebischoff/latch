...
| [routing-and-libraries.md](./routing-and-libraries.md) | Explicit routes (not catch-all), master-detail, Ant Design / RHF / React Query |
...
- **Latch is the security boundary** — handlers orchestrate; DAL enforces manifest.
