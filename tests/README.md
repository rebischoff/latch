...
**Full CRM-parity e2e** (jobs, customers, verification, restore, etc.) graduates with the business-app template — [discussion 07](../packages/docs/discussions/07-template-scaffold.md).
